...
| 教程 | 读者 | 特点 | 从哪开始 |
|---|---|---|---|
| [《中文仓颉程序设计》](docs/中文仓颉程序设计/README.md) | 任何阶段的人——零基础到想系统学到底 | 三卷 20 章手册级（第一卷零基础入门）+ 附录 A/B/C 速查 + 思考题答案 | 从第一卷开始，想认真学一门语言、并当案头手册查 |
| [教学教程](docs/tutorial/README.md) | 想边学边掌握 zhc 工具链的人 | 11 章字典级 + 每章官方对照 + 诊断/宏展开/语言包玩法 | 想深入 zhc 生态或对照官方文档 |

配套资产：[术语表](docs/术语表.md)（官方术语 ↔ 中文说法，两教程统一用词）·
